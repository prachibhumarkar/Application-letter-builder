...
<form action="" method="post">
    <button name="1" class="click">Admission acceptance</button>
    <button name="2" class="click">Internship acceptance</button>
    <button name="3" class="click">Job  acceptance</button>
    <button name="4" class="click">Promotion acceptance</button>
    <button name="5" class="click">Resignation acceptance</button>
